...
public class AccountsControllerTest {
    ...
    public void listAccounts() {
        ResponseEntity<List<AccountDTO>> exchange = this.restTemplate.exchange(
                "/accounting/accounts/",
    ...
    public void createAccount() {
        ResponseEntity<AccountStoreResponse> exchange = this.restTemplate.exchange(
                "/accounting/accounts",
                HttpMethod.POST, new HttpEntity<>(new AccountCreateRequest("00000000000000000000", "Наличные", null, "RUR", "vzotov", null)),
                AccountStoreResponse.class
        );
        assertThat(exchange.getBody()).isEqualToComparingFieldByField(
    ...
    public void modifyAccount() {
        ...
        assertThat(this.restTemplate.exchange(
                ...
                HttpMethod.GET, new HttpEntity<>(null),
                AccountDTO.class
        ).getBody()).isEqualToComparingFieldByField(
                new AccountDTO("40817810000016123456", "Tinkoff", "044525974", "USD", "vzotov", Collections.singletonList("tinkoff_40817810000016123456"))
        );
    }

    @Test
    public void listOperations() {
        ResponseEntity<List<AccountOperationDTO>> exchange = this.restTemplate.exchange(
    ...
    public void listHoldOperations() {
        ResponseEntity<List<HoldOperationDTO>> exchange = this.restTemplate.exchange(
    ...
    public void getOperation() {
        ...
        ResponseEntity<AccountOperationDTO> exchange = this.restTemplate.exchange(
    ...
    public void deleteOperation() {
        ...
        assertThat(exchange.getBody()).isEqualToComparingFieldByField(new AccountOperationDTO(
                "40817810108290123456",
    ...
    public void createOperation() {
        ...
        ).getBody()).isNotEmpty().haveExactly(1, new Condition<AccountOperationDTO>() {
            @Override
            public boolean matches(AccountOperationDTO value) {
